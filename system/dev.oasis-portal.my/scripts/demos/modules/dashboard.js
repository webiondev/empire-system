  //    //lecturer dashboard dynamic data load
  //   $scope.module_count= data;


  //    $http({
  //   }
  // method: 'get',
  // url: base_url + '/lecturer/getmodulecount'
...
angular.module('theme.demos.dashboard', [
  ...
  .controller('DashboardController', ['$scope', '$http', '$modal', '$location','$route', 'SessionService', 'WebService', '$timeout', '$window', function($scope, $http, $modal, $location, $route, SessionService, WebService, $timeout, $window) {
    'use strict';
