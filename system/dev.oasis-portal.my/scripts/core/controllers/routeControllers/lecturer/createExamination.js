app.register.controller('createExamination', ['$scope', '$http', 'pinesNotifications', '$location', '$routeParams', '$window', function($scope, $http, pinesNotifications, $location, $routeParams, $window){
    ...
    $scope.submit = function(credentials) {
      ...
      $http({
      method: 'post',
      url: base_url + '/lecturer/create-examination',
      data: $data,
      ...
      success(function(data, status, headers, config) {
        ...
        if(data['success']) {
          ...
          $location.path('/exam-edit/' + data["id"]);
          pinesNotifications.notify({
          
            title: 'Success',
            text: 'Examination successfully created.',
            type: 'success',
            hide: true
          });
