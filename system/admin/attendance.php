...
include_once("inc/security.php");
  ...
  $dbcon->connect();
    ...
    $strAction = "Give Attendance";

    if ($user > 0)
    {
      $strAction = "Submit Attendance";
        ...
        <div class="wrapper wrapper-content">
              <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form class="form-horizontal" action="attendanceaction.php" method="post">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-4 col-sm-offset-2">
                                        <a class="btn btn-white" href="attendance.php">Cancel</a>
