                                  ...
                                  <tr id="item-<?php echo $row[idrequest];?>">
                                    <!--  <td><img src="<?php echo extractfile($row[photo], 'preview', '200x63%23'); ?>" class="img-thumbnail" /></td> -->
                                      ...
                                      <!--   <div class="btn-group action-tooltip">
                                         ...
                                         <div class="btn-group action-tooltip">
                                          <a href="delete.php?requestid_r=<?php echo $row[idrequest]; ?>" class="btn-white btn btn-sm" data-toggle="tooltip" data-placement="top" title="delete"><i class="fa fa-remove"></i></a>
                                        </div>
                                      </td>
                                  </tr>
