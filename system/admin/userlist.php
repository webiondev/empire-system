...
$entrycount=$dbcon->getexec("SELECT COUNT(1) FROM user ".$strwhere);
...
$userlist=$dbcon->exec("SELECT * FROM user ".$strwhere." ORDER BY name DESC, type ASC LIMIT ".$position.", ".ITEM_PER_PAGE);
