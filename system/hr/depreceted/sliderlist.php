...
$entrycount=$dbcon->getexec("SELECT COUNT(1) FROM tblbanner ".$strwhere);
...
$sliderlist=$dbcon->exec("SELECT tblbanner.*, tblbanner.title FROM tblbanner ORDER BY tblbanner.date_created DESC LIMIT ".$position.", ".ITEM_PER_PAGE);
                                  ...
                                  <tr id="item-<?php echo $row[id];?>">
                                      ...
                                      <td class="text-center">
                                        <div class="btn-group action-tooltip">
                                          <a href="slider.php?bannerid=<?php echo $row[id]; ?>" class="btn-white btn btn-sm" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-pencil"></i></a>
                                        </div>
                                      </td>
                                  </tr>
