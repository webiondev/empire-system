...
$entrycount=$dbcon->getexec("SELECT COUNT(1) FROM course ".$strwhere);
...
$courselist=$dbcon->exec("SELECT * FROM course ".$strwhere." ORDER BY year DESC, name ASC LIMIT ".$position.", ".ITEM_PER_PAGE);
...
<body class="md-skin">
  ...
  ?>
                                  <tr id="item-<?php echo $row[idcourse];?>">
                                      ...
                                      <td class="text-center">
                                        <div class="btn-group action-tooltip">
                                          <a href="course.php?courseid=<?php echo $row[idcourse]; ?>" class="btn-white btn btn-sm" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-pencil"></i></a>
                                        </div>
                                         <div class="btn-group action-tooltip">
                                          <a href="delete.php?courseid=<?php echo $row[idcourse]; ?>" class="btn-white btn btn-sm" data-toggle="tooltip" data-placement="top" title="delete"><i class="fa fa-remove"></i></a>
                                        </div>
                                      </td>
                                  </tr>
