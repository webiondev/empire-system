...
<head>
  <meta charset="utf-8">
  <title>Education Oasis - For Knowledge, Career and Life</title>
	...
	<link rel="stylesheet" href="bower_components/angular-tour/dist/angular-tour.css"/>
...
>
	...
	<div id="personalNotifications">
		<script type="text/ng-template" id="personalNotifications.html">
	      ...
	      <div class="modal-footer">
	          <button class="btn btn-brown" ng-click="ok()">I'm acknowledged.</button>
	      </div>
	   </script>
   </div>
				...
				<footer role="contentinfo" ng-show="!layoutLoading">
					<div class="clearfix">
						<ul class="list-unstyled list-inline pull-left">
							<li>Education Oasis &copy; 2017</li>
						</ul>
	...
	<script type="text/javascript">
	    var _config = { user: '<% $type %>', name: '<% $user->name %>', id: '<% $user->id %>', csrf: '<% $csrf %>' };
	</script>
	...
	<!-- UNCOMMENT THIS ONE ONLY IF GOT GMAP ERROR LOADING -->
	<!-- <script type='text/javascript' src='http://maps.google.com/maps/api/js?sensor=true'></script> -->

	<!-- <script type='text/javascript' src='scripts/map/maps.google1.js'></script> -->
	...
	<script src="bower_components/jquery-2/jquery.js"></script>
	<script src="bower_components/velocity.min.js"></script>
	...
	<!-- MODAL MANUAL SCRIPTS -->
	<script src="scripts/manual/mm.js"></script>
