...
CREATE TABLE IF NOT EXISTS `employer` (
  ...
  PRIMARY KEY (`idemployer`) USING BTREE,
...
INSERT INTO `enquiry` (`idenquiry`, `enquirer`, `date_time`, `description`, `email`) VALUES
(13, 'rahman', '2018-12-31 12:59:00', 'How can come back sing?', 'sokhter@yahoo.com'),
(16, 'rahman', '2018-12-31 12:59:00', 'How can come back sing?', 'enquirer@empire.com');
...
(3, 1, '2018-01-14 00:59:00', '', '47630', 'Subang Jaya', 'D 19 08 USJ 19 City Mall', 'Malaysia');
...
(3, 2, '2018-01-06', '2018-01-18', 'medical', 'active', '');
...
--
-- Table structure for table `recruitrequest`
--

DROP TABLE IF EXISTS `recruitrequest`;
CREATE TABLE IF NOT EXISTS `recruitrequest` (
  `idrequest` int(11) NOT NULL AUTO_INCREMENT,
  `recruit_iduser` int(11) NOT NULL,
  `employer_iduser` int(11) NOT NULL,
  `date` date NOT NULL,
  PRIMARY KEY (`idrequest`),
  KEY `fk_recruitrequest1` (`recruit_iduser`),
  KEY `fk_recruitrequest2` (`employer_iduser`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8;

--
-- Dumping data for table `recruitrequest`
--

INSERT INTO `recruitrequest` (`idrequest`, `recruit_iduser`, `employer_iduser`, `date`) VALUES
(4, 3, 7, '2018-01-10'),
(6, 3, 7, '2018-01-13');
...
(2, 'Customer Service 102', 'customer service', 'Introduction to customer service', 1, '000', 'shah alam', 'usj', 'Sing');
...
INSERT INTO `user` (`iduser`, `name`, `email`, `password`, `type`, `remember_token`, `image`, `postcode`, `city`, `street`, `country`) VALUES
...
ALTER TABLE `employee_training`
  ADD CONSTRAINT `fk_employee_training_employee1` FOREIGN KEY (`employee_id`) REFERENCES `employee` (`idemployee`),
...
ALTER TABLE `employee_training_mat`
  ADD CONSTRAINT `fk_employee_training_mat_employee1` FOREIGN KEY (`employee_id`) REFERENCES `employee` (`idemployee`),
...
ALTER TABLE `employment_history`
  ADD CONSTRAINT `fk_employment_history_employee1` FOREIGN KEY (`employee_id`) REFERENCES `employee` (`idemployee`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_employment_history_employer1` FOREIGN KEY (`employer_id`) REFERENCES `employer` (`idemployer`) ON UPDATE CASCADE;
...
--
-- Constraints for table `recruitrequest`
--
ALTER TABLE `recruitrequest`
  ADD CONSTRAINT `fk_recruitrequest2` FOREIGN KEY (`employer_iduser`) REFERENCES `user` (`iduser`) ON DELETE CASCADE ON UPDATE CASCADE;
